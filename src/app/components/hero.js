...
export default function HeroSection() {
  const heading = "Brindavan Gardens".split("");
  ...
  return (
    <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <Image
          src="/assets/brindavangardens.jpg"
          alt="Brindavan Gardens Background"
          fill
          priority
      ...
      <div className="relative z-10 text-center px-4">
        ...
        >
          A Stunning Symphony of Fountains & Flowers
        </motion.p>
        ...
        <motion.h1
          ...
          initial="hidden"
          animate="visible"
          className="text-green-500 text-4xl md:text-[80px] lg:text-[120px] font-semibold tracking-wider flex justify-center"
        >
